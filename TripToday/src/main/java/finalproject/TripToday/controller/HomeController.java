...
public class HomeController {
    ...
    public String home(Model model) {
        ...
        testimonials.add(new Testimonial("/images/traveler2.jpg", "\"What a fantastic adventure! Signing up was a breeze online. The guides knew the nature trails inside out and were super friendly. Saw breathtaking landscapes thanks to their expert planning\""));
        testimonials.add(new Testimonial("/images/traveler3.jpg", "\"Everything was handled perfectly, from the easy booking to the tour itself. Our guide was exceptionally knowledgeable and made exploring the region fun. Absolutely brilliant service and location!\""));
